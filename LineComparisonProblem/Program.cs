...
namespace LineComparisonProblem
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int compare = LengthAB.CompareTo(LengthCD);
            if (compare > 0)
            {
                Console.WriteLine("Length of LineAB is greater than LineCD");
            }
            else if (compare < 0)
            {
                Console.WriteLine("Length of LineCD is greater than LineAB");
            }
            else
            {
                Console.WriteLine("Length of LineCD is equal to LineAB");
            }
        }
    }
}
